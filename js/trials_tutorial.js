...
var rh_demo_noReachableGoal_1 =
  demo_responseHandler_generator_noReachableAction(action_mapping_a);
...
var rh_demo_noReachableGoal_2 =
  demo_responseHandler_generator_noReachableAction(action_mapping_b);
...
var demo1 = new DemoTrial(
  ...
  "The " +
    instruction_set_a +
    " keys move the circle around maze.<br> Try moving around! <br><br> ",
  "#task_display",
  "#trial_text"
);
...
var demo2 = new DemoTrial(
  ...
  "The colored tile is your goal.<br> Try going to your goal! <br>" +
    ' <span style="color: #707070">Use the ' +
    instruction_set_a +
    " keys to move.</span>",
  "#task_display",
  "#trial_text"
